...
const FeaturedProductCard = () => {
	return (
		<div className="w-1/2 bg-opacity-10 px-4 py-12">
			<ShimmerBorderCard />
		</div>
	);
};
...
const ShimmerBorderCard = () => {
	return (
		<div className="group relative mx-auto w-full max-w-sm overflow-hidden rounded-lg bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 p-0.5 transition-all duration-500 hover:bg-slate-800/50">
			<div className="relative z-10 flex flex-col items-center justify-center overflow-hidden rounded-[7px] bg-slate-600 p-8 transition-colors duration-500 group-hover:bg-slate-800">
